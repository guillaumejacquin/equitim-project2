...
def callAllDates2Date(Class):
    ...
    Class.Datesremb1 = get_all_dates_between_2_dates_with_special_begin_njo(Class, Class.DDCI, Class.DCF, Class.DR1, Class.DCF, False, False) #Rjouter la premiere date
